                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(color: AppColor.gradientFirst,width: 2),
                          ...
                          Container(
                            alignment: Alignment.center,
                              ...
                              child:  Center(child: Text("SET EXAMS",style: TextStyle(
                                  ...
                                  color: Colors.black,fontSize: screenSize.width*1/30
                              ) ))
                          ),)
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child:  Center(child: Text("Explore Courses",style: TextStyle(
                                  color: Colors.black,fontSize: screenSize.width*1/35
                              ) ))
                          ),)
                        ],
                      ),
